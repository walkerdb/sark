...
sqs = SearchQuerySet().date_facet('date', start_date=date(1955, 1, 1), end_date=date(2015, 1, 1), gap_by="year").facet('host').facet('performers').facet('instruments').facet('faceted_model_type').facet('location')
